...
// Add role FIXME
// Getting the current list of departments from the database to pass into the addRole prompt
// FIXME: set deparmentList = [], move the actual query into departmentList after connection.query, and then after throw err set deparmentList = res
